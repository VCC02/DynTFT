...
{$IFDEF MouseDoubleClickSupport}
  procedure TDynTFTButton_OnDynTFTBaseInternalDoubleClick(ABase: PDynTFTBaseComponent);
  begin
...
begin
  ...
  {$IFDEF IsDesktop}
    ...
    {$ENDIF}
    {$IFDEF MouseDoubleClickSupport}
      //ABaseEventReg.DoubleClickEvent^ := TDynTFTButton_OnDynTFTBaseInternalDoubleClick;
    {$ENDIF}
